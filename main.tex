...
\begin{mathpar}
  ...
  \and
  \inferrule{\jv{\Gamma}{v}{A_\op}}{\jc \Gamma {\app{\eff\op}{v}}{B_\op\bang \Sigma}}(\op : A_\op \to B_\op \in \Sigma)
  \and
...
We now demonstrate implementations for handlers for the parametrized theories from \Cref{sec:examples}.
