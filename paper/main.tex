...
\lstdefinelanguage{cambria}{
  ...
  literate=
    ...
    {\$tids}{{\textcolor{paramcolor}{\$tids}}}5
...
\end{array}
\]
As the ($\beta$-ext) rule is purely administritive for existential reduction,
we define $c_1 \approx_\exists c_2$ iff $c_1$ and $c_2$ are equal up to the congruence closure of:
\[
  \unpack \pack(\psi, A, v) \as (\psi, x) \iin c \approx c[v / x]
\]
